...
from seine.apis import train_segmentor, set_random_seed, init_random_seed
from seine.datasets import build_dataset
from seine.models import build_segmentor
from seine.models.utils import revert_sync_batchnorm
...
def main():
    ...
    if cfg.checkpoint_config is not None:
        # save seine version, config file content and class names in
        # checkpoints as meta data
        cfg.checkpoint_config.meta = dict(seine_version=f'{__version__}+{get_git_hash()[:7]}', config=cfg.pretty_text)
